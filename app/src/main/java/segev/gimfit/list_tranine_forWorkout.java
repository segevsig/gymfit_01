...
public class list_tranine_forWorkout extends AppCompatActivity {
    String codeOfChoces;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_list_tranine_for_workout);
        listView=findViewById(R.id.list_for_workout);
    ...
    private void showEvent(String substring) {
        Intent intent=new Intent(list_tranine_forWorkout.this,Running_activity.class);
